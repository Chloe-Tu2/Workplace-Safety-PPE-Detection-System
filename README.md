...
1. **01_data_exploration.ipynb** - Download dataset, create stratified train/val/test split (70/15/15)
2. **02_model_training.ipynb** - Train YOLOv8s model for 200 epochs (~1.3 hours on GPU)
3. **03_evaluation.ipynb** - Evaluate model on test set, generate metrics
4. **04_demo.ipynb** - Interactive demo, batch inference, model export

### 4. View Results
- Training visualizations: `results/visualizations/`
